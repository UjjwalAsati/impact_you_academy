    ...
    >
      {[...items, ...items, ...items].map(
        (item, i) => (
          <div
            key={i}
            className="flex items-center gap-3 text-slate-400 hover:text-yellow-500 transition-colors cursor-pointer"
          >
            <item.icon size={28} />
...
export default function HomePage() {
  ...
  const programs = [
    {
      title:
        "Recruiter Foundation Program",
      duration: "30 Days",
      audience:
        "Graduates & Starters",
      description:
        "Comprehensive introduction to recruitment fundamentals, sourcing strategies, and hiring process management.",
      features: [
        "Full-cycle training",
        "Sourcing lab sessions",
    ...
    {
      title:
        "Advanced Staffing & TA Program",
      duration: "45-60 Days",
      audience:
        "HR Professionals",
      description:
        "Advanced program covering strategic talent acquisition, staffing operations, and recruitment analytics.",
      features: [
        "Strategic TA planning",
    ...
    },
    {
      ...
      audience:
        "Experienced Pros",
      description:
        "Intensive certification program for professionals seeking to formalize recruitment expertise.",
      features: [
          ...
          >
            ...
            <MagneticWrapper>
              ...
              {brochureLink ? (
                ...
                <button
                  disabled
                  className="px-8 py-4 bg-slate-300 text-slate-500 text-base font-bold rounded-full cursor-not-allowed"
                >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <SpotlightCard className="bg-slate-50 rounded-[2.5rem] p-8 border border-slate-200/60">
                  ...
                  <p className="text-slate-600 text-sm md:text-base leading-relaxed">
                    Direct access to veterans who review your calls & strategies.
                  </p>
                ...
                <SpotlightCard className="bg-slate-50 rounded-[2.5rem] p-8 border border-slate-200/60">
                  ...
                  <p className="text-slate-600 text-sm md:text-base leading-relaxed">
                    Curriculum updated to match global recruitment trends.
                  </p>
              ...
              <SpotlightCard className="flex-1 bg-slate-900 rounded-[2.5rem] p-8 md:p-10 text-white flex flex-col justify-between border border-slate-800 shadow-xl">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-slate-300 text-sm md:text-base leading-relaxed">
                    Our graduates don't just get jobs; they get promoted faster. We teach strategy, not just tasks.
                  </p>
              ...
              (program, index) => (
                ...
                >
                  ...
                  <TiltCard className="h-full">
                    ...
                    <div
                      className={`relative p-8 rounded-[2rem] h-full flex flex-col transform-gpu ${
                        program.popular
                    ...
                    >
                      ...
                      <Link
                        to="/programs"
                        className="block mt-auto pointer-events-auto"
                      >
                        <motion.button
                          whileHover={{
                            scale: 1.02
