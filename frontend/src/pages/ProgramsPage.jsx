...
export default function ProgramsPage() {
  ...
  const handleEnrollClick = (program) => {
    ...
    if (isAdmin) {
      alert(
        "Admins cannot enroll in programs."
      );
      return;
    }
    ...
    <div className="min-h-screen bg-slate-50 font-sans selection:bg-yellow-100">
      ...
      <section className="relative h-screen flex flex-col justify-center items-center overflow-hidden bg-white pt-20">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full z-0 pointer-events-none">
          ...
          <div
            className="absolute bottom-[10%] right-[-10%] w-[600px] h-[600px] bg-yellow-50 rounded-full blur-3xl opacity-60 mix-blend-multiply animate-float"
            style={{
              animationDelay:
                "1.5s"
            }}
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4 flex flex-col items-center justify-center h-full pb-20">
          ...
          <p className="animate-fade-up delay-300 text-lg md:text-xl text-slate-600 leading-relaxed mb-10 max-w-2xl">
            ...
            From foundational recruitment skills
            to advanced talent acquisition
            strategies designed by industry experts.
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600">
              Click on any program to view the detailed syllabus and features.
            </p>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-8 flex flex-col h-full">
                      ...
                      {seatBookingEnabled && (
                        <div
                          className="mb-6 rounded-2xl border border-yellow-200 bg-gradient-to-r from-yellow-50 to-amber-50 p-4"
                          onClick={(e) =>
                            e.stopPropagation()
                          }
                        >
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-xs text-slate-600 mt-1">
                                ...
                                <span className="font-semibold">
                                  ...
                                  ₹
                                  {remainingAfterBooking.toLocaleString(
                                    "en-IN"
                                  )}
          ...
          <div className="relative w-full max-w-3xl bg-white rounded-3xl shadow-2xl overflow-hidden animate-modal flex flex-col max-h-[85vh]">
            ...
            <div className="bg-slate-900 p-6 md:p-8 text-white relative flex-shrink-0">
              ...
              <div className="flex gap-3 mb-4 flex-wrap">
                ...
                {/* SEAT BOOKING BADGE */}
                {selectedProgram.allowSeatBooking ===
                  true && (
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-yellow-500 text-slate-900 text-xs font-bold uppercase">

                    <CalendarCheck size={12} />

                    Book Seat ₹
                    {Number(
                      selectedProgram.seatBookingAmount ||
                        999
                    ).toLocaleString(
                      "en-IN"
                    )}
              ...
              <p className="text-slate-300 text-sm md:text-base opacity-90 line-clamp-2">
                  ...
                  <div className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-2xl p-5">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="w-12 h-12 rounded-xl bg-yellow-100 flex items-center justify-center shrink-0">
                        ...
                        <CalendarCheck className="w-6 h-6 text-yellow-700" />
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-600 mt-1">
                          ...
                          Pay the remaining amount later.
                ...
                {selectedProgram.learningOutcomes &&
                  ...
                  <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                    ...
                    <ul className="grid sm:grid-cols-2 gap-3">
                      ...
                      {selectedProgram.learningOutcomes.map(
                        (
                          outcome,
                          idx
                        ) => (
