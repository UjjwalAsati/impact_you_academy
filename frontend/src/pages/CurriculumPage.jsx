...
export default function CurriculumPage() {
  ...
  const philosophyPrinciples = [
    {
      ...
      description:
        "Curriculum structured around actual recruitment workflows rather than theoretical concepts, ensuring practical applicability."
    },
    {
      icon: (
      ...
      title:
        "Industry-Practitioner Design",
      description:
        "Content developed by active recruitment professionals with current market knowledge and practical experience."
    },
    {
      icon: (
      ...
      description:
        "Systematic progression from fundamental concepts to advanced applications, building competency at each stage."
    }
  ];
  ...
  const curriculumModules = [
    {
      category:
        "Foundation Modules",
      description:
        "Build the bedrock of your recruitment career with essential industry knowledge.",
      modules: [
        {
          title:
    ...
    },
    {
      ...
      description:
        "Master the day-to-day operations of managing candidates and interviews.",
      modules: [
        {
          title:
            "Candidate Screening",
    ...
    },
    {
      ...
      description:
        "Elevate your expertise with high-level negotiation and analytics skills.",
      modules: [
        {
          title:
            "Offer Management",
    ...
    },
    {
      ...
      description:
        "Prepare yourself for long-term success and ethical practice.",
      modules: [
        {
          title:
            "Ethics & Compliance",
  ...
  return (
    <div className="bg-slate-50 font-sans selection:bg-yellow-200 overflow-x-hidden min-h-screen">
      ...
      <section className="relative w-full min-h-[100dvh] flex flex-col justify-center items-center overflow-hidden bg-white px-4">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
          ...
          <motion.div
            ...
            className="absolute bottom-[10%] left-[-5%] w-[50vw] h-[50vw] min-w-[500px] min-h-[500px] bg-blue-100/50 rounded-full blur-[100px] mix-blend-multiply"
          />
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto text-center flex flex-col items-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white/60 backdrop-blur-xl border border-slate-200/80 text-slate-800 text-sm font-bold mb-8 shadow-sm"
          >
          ...
          <motion.p
            ...
            className="text-lg md:text-xl lg:text-2xl text-slate-600 leading-relaxed max-w-3xl mx-auto font-medium"
          >
            We don't just teach theory. Our curriculum is engineered around{" "}
            <span className="font-extrabold text-slate-900">
              real-world workflows
            </span>
            , transforming you from a student into a practitioner.
          </motion.p>
      ...
      <section
        id="content-section"
        className="py-20 md:py-32 bg-slate-50 relative z-20 border-t border-slate-200/50"
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {philosophyPrinciples.map(
              (
                ...
                <SpotlightCard
                  key={index}
                  className="flex flex-col p-8 bg-white border border-slate-200/80 rounded-[1.5rem] shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-500 h-full"
                >
                  ...
                  <motion.div
                    ...
                    className="w-14 h-14 bg-slate-50 rounded-xl flex items-center justify-center mb-5 border border-slate-100"
                  >
                    {principle.icon}
                  </motion.div>
      ...
      <section className="py-20 md:py-32 bg-white relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12 md:mb-16">
            ...
            >
              Select a category below to view detailed modules.
            </motion.p>
                ...
                (cat) => (
                  ...
                  >
                    ...
                    {activeCategory ===
                      ...
                      <motion.div
                        layoutId="activeTab"
                        className="absolute inset-0 bg-slate-900 rounded-xl md:rounded-full"
                        transition={{
                          type: "spring",
                          stiffness: 300,
                          damping: 25
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="text-center mb-10">
                  ...
                  <p className="text-slate-500 mt-3 text-base max-w-2xl mx-auto font-medium">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                  ...
                  {currentCategoryData?.modules.map(
                    (
                      module,
                      modIndex
                    ) => (
      ...
      <section className="py-32 bg-slate-900 border-t border-slate-800 flex justify-center items-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <motion.p
            ...
            className="text-lg text-slate-300 mb-10 max-w-2xl mx-auto font-medium"
          >
            ...
            {brochureLink ? (
              ...
              >
                ...
                <motion.button
                  ...
                  className="group inline-flex items-center gap-3 px-8 py-4 bg-yellow-500 text-slate-900 rounded-full font-bold text-lg shadow-[0_0_30px_rgba(234,179,8,0.4)] hover:shadow-[0_0_60px_rgba(234,179,8,0.6)] transition-all overflow-hidden"
                >
