...
import { fetchBrochureLink } from "../services/siteSettingsService";
...
export default function StaffingTrainingPage() {
  ...
  const [openModuleIndex, setOpenModuleIndex] =
    useState(null);

  // ==============================
  // COMMON BROCHURE LINK
  // ==============================

  const [brochureLink, setBrochureLink] =
    useState("");

  useEffect(() => {
    const loadBrochureLink = async () => {
      try {
        const link =
          await fetchBrochureLink();

        setBrochureLink(link);
      } catch (error) {
        console.error(
          "Failed to load brochure link:",
          error
        );
      }
    };
  ...
  const yBg1 = useTransform(
    scrollYProgress,
    [0, 1],
    [0, 400]
  );

  const yBg2 = useTransform(
    scrollYProgress,
    [0, 1],
    [0, -300]
  );
  ...
  const syllabusIndustryReady = [
    {
      title: "M1: HR & Staffing Fundamentals",
      topics: [
        "Introduction to HR & Staffing",
        "Generalist vs Recruiter",
        "Hiring Types: Perm, Contract",
        "Ethical Hiring Basics"
      ]
    },
    {
      title: "M2: Recruitment Process",
      topics: [
        "Step-by-Step Hiring Flow",
        "Reading JDs & Checklists",
        "Must-Have vs Good-to-Have",
        "Offer & Joining Process"
      ]
    },
    {
      title: "M3: Candidate Sourcing",
      topics: [
        "Job Portals & LinkedIn",
        "Boolean Search Basics",
        "Resume Filtering",
        "Target: Source 20 profiles/day"
      ]
    },
    {
      title: "M4: Screening & Comm",
      topics: [
    ...
    {
      title: "M5: Interview Coordination",
      topics: [
        "Scheduling & Calendars",
        "Client Coordination",
        "Feedback Follow-up",
        "Daily Hiring Reports"
      ]
    },
    {
      title: "M6: Offer & Ops Basics",
      topics: [
        "Offer Process & Documents",
        "Joining Formalities",
        "Attendance & Payroll",
        "Employee Life Cycle"
      ]
  ...
  const syllabusCSRP = [
    {
      title: "M1: Staffing Industry",
      topics: [
        "Indian & Global Landscape",
        "Perm vs Contract",
        "Recruiter Ecosystem"
      ]
    },
    {
      title: "M2: End-to-End Recruitment",
      topics: [
        "JD Understanding",
        "Sourcing to Interviews",
        "Offer Management"
      ]
    },
    {
      title: "M3: Sourcing Techniques",
      topics: [
        "Job Portals & Social",
        "Boolean & LinkedIn",
        "Referrals & Bulk Hiring"
      ]
    },
    {
      title: "M4: Screening Skills",
      topics: [
        "Resume Analysis",
  ...
  const syllabusLabourLaw = [
    {
      title: "M1: Labour Law Foundations",
      topics: [
    ...
    {
      title: "M4: Social Security",
      topics: [
        "Provident Fund (EPF)",
        "ESI Eligibility & Claims",
        "Labour Welfare Fund"
      ]
    },
    {
      title: "M5: Workplace Safety",
      topics: [
        "POSH Act",
  ...
  const programs = [
    {
      ...
      idealFor:
        "Fresh Graduates, HR Interns, and Career Switchers looking for affordable exposure.",
    ...
    },
    {
      ...
      idealFor:
        "Those seeking a recognized certification and deep operational knowledge.",
    ...
    },
    {
      ...
      idealFor:
        "HR Ops professionals and those wanting to master statutory compliance.",
  ...
  return (
    <div className="bg-slate-50 font-sans selection:bg-yellow-200 overflow-x-hidden">
      ...
      <section className="relative w-full min-h-[100dvh] flex flex-col justify-center items-center overflow-hidden bg-white px-4 pt-28 pb-32 md:py-0">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
          ...
          <motion.div
            ...
            className="absolute top-[10%] right-[-5%] w-[40vw] h-[40vw] min-w-[400px] min-h-[400px] bg-yellow-100/60 rounded-full blur-[100px] mix-blend-multiply"
          />
          ...
          <motion.div
            ...
            className="absolute bottom-[10%] left-[-10%] w-[50vw] h-[50vw] min-w-[500px] min-h-[500px] bg-blue-100/50 rounded-full blur-[100px] mix-blend-multiply"
          />
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto text-center flex flex-col items-center mt-8">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-slate-900 text-yellow-400 text-sm font-bold uppercase tracking-wider mb-8 shadow-xl"
          >
          ...
          <div className="overflow-hidden mb-4">
            ...
            <motion.h1
              ...
              className="text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-tight leading-[1.1] text-slate-900 pb-2 mb-6"
            >
              Staffing & HR
              <br />
          ...
          <motion.p
            ...
            className="text-lg md:text-xl lg:text-2xl text-slate-600 leading-relaxed max-w-3xl font-medium mb-12"
          >
          ...
          >
            ...
            <MagneticWrapper>
              ...
              {brochureLink ? (
                ...
                <button
                  disabled
                  className="w-full sm:w-auto flex justify-center items-center gap-2 px-8 py-4 bg-slate-100 border border-slate-200 text-slate-400 font-bold rounded-full cursor-not-allowed"
                >
                  <Download size={20} />
      ...
      <section
        id="programs-section"
        className="py-24 md:py-32 bg-slate-50 relative z-10 border-t border-slate-200/50"
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 md:mb-20">
            ...
            >
              Click on a card below to view the detailed syllabus and fee structure.
            </motion.p>
              ...
              (item, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <div
                      className={`relative p-8 md:p-10 rounded-[2.5rem] h-full flex flex-col transform-gpu ${
                        item.popular
                    ...
                    >
                      ...
                      {item.popular && (
                        <motion.div
                          ...
                          className="absolute -top-5 left-1/2 -translate-x-1/2 bg-yellow-500 text-slate-900 px-6 py-2 rounded-full text-xs font-bold uppercase tracking-widest flex items-center gap-2 shadow-lg"
                        >
                          <Sparkles
                            size={14}
                            fill="currentColor"
                      ...
                      <div className="flex justify-between items-start mb-8">
                        ...
                        <div
                          className={`p-4 rounded-[1.2rem] flex-shrink-0 shadow-inner ${
                            item.color === "blue"
                        ...
                        <div className="text-right pl-2">
                          ...
                          <span className="block text-3xl font-extrabold text-slate-900 whitespace-nowrap">
                            {item.price}
                          </span>
                      ...
                      <p className="text-slate-600 leading-relaxed text-base mb-8 flex-grow font-medium">
                        {item.desc}
                      </p>
        ...
        {selectedProgram && (
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div
                className="p-0 overflow-y-auto bg-slate-50 flex-grow"
                style={{
                  scrollbarWidth: "thin"
                }}
              >
                ...
                <div className="p-8">
                  ...
                  <div className="space-y-3">
                    ...
                    {selectedProgram.syllabus.map(
                      (mod, idx) => (

                        <div
                          key={idx}
                          className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm hover:border-yellow-400 transition-colors"
                        >
              ...
              <div className="p-6 border-t border-slate-100 bg-white flex flex-col sm:flex-row gap-4 justify-between items-center flex-shrink-0">
                ...
                <div className="text-sm text-slate-500 font-medium">
                  <span className="font-bold text-slate-900 bg-yellow-100 px-2 py-1 rounded">
                    Note:
                  </span>{" "}
                  Live classes + Recording access
                </div>
                ...
                >
                  <motion.button
                    ...
                    className="w-full px-8 py-3 bg-yellow-500 hover:bg-yellow-400 text-slate-900 font-bold rounded-xl transition-colors shadow-lg shadow-yellow-500/20 flex items-center justify-center gap-2"
                  >
                    Enroll in Batch
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            {syllabusCSRP
              ...
              .map((mod, idx) => (
                ...
                <motion.div
                  ...
                  className="p-6 rounded-[1.5rem] border border-slate-200/80 bg-slate-50 hover:bg-white hover:shadow-xl hover:-translate-y-1 hover:border-yellow-300 transition-all duration-300 text-center flex flex-col items-center justify-center"
                >

                  <h4 className="font-bold text-slate-900 text-base md:text-lg leading-tight mb-2 tracking-tight">
                    {mod.title.split(":")[1] ||
                      mod.title}
                  </h4>

                  <span className="text-xs font-bold text-yellow-600 uppercase tracking-widest bg-yellow-100/50 px-3 py-1 rounded-full">
                    Module {idx + 1}
                  </span>
            ...
            <motion.div
              ...
              className="col-span-2 md:col-span-4 p-6 rounded-[1.5rem] border-2 border-dashed border-slate-300 bg-slate-50/50 text-center text-slate-500 font-bold text-lg flex items-center justify-center"
            >
      ...
      <section className="py-32 bg-slate-900 flex justify-center items-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <motion.p
            ...
            className="text-xl text-slate-300 mb-12 max-w-2xl mx-auto font-medium"
          >
              ...
              {brochureLink ? (
                ...
                >
                  <motion.button
                    ...
                    className="px-10 py-5 rounded-full bg-yellow-500 text-slate-900 font-bold text-xl transition-all shadow-[0_0_30px_rgba(234,179,8,0.4)] hover:shadow-[0_0_60px_rgba(234,179,8,0.6)] flex items-center gap-3"
                  >
                    Get Full Brochure
                ...
                <button
                  disabled
                  className="px-10 py-5 rounded-full bg-slate-700 text-slate-400 font-bold text-xl flex items-center gap-3 cursor-not-allowed"
                >
                  Brochure Unavailable
